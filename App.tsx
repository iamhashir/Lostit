...
const styles = StyleSheet.create({
  ...
  tabBar: { position: 'absolute', left: 14, right: 14, bottom: 10, minHeight: 66, borderRadius: 22, backgroundColor: '#111719F2', borderWidth: 1, borderColor: theme.border, flexDirection: 'row', padding: 7 },
